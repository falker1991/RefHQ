...
Version 0.5.27 is the Phase 1 pilot-administration release. Rating history adds searchable referee filtering and replaces the date checklist with From/Through calendar controls.
