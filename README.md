...
Version 0.10.1 adds private personal iCalendar feed connections and a unified My Assignments schedule combining Law18Ref and external games, with corrected server-only database privileges for feed synchronization.
