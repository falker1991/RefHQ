...
Version 0.23.1 fixes account merges when the surviving record adopts an email held by the secondary record. Version 0.23.0 added scoped Site Supervisor access, posted-assignment corrections, full event-day official details, and an orange schedule-change workflow that remains pending until Event Admin confirmation.
