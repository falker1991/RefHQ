-- Law18Ref v0.30.1: event-configurable External Check-In completion.
alter table public.events
  add column if not exists external_check_in_confirmation_required boolean not null default true;
