...
test("v0.40.1 confirms atomic crew-rating writes before closing", async () => {
...
test("v0.40.1 reduces event and crew-rating database round trips", async () => {
  const [page, client, migration, packageJson] = await Promise.all([
