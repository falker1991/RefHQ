...
test("v0.38.0 separates referee names and uses last-name-first selectors", async () => {
  const [page, client, migration, packageJson] = await Promise.all([
    read("app/page.tsx"),
    read("app/supabase-client.ts"),
