...
test("Version 0.31.2 uses the dashboard loading label, favicon metadata, and preserved Worker secrets", async () => {
  ...
  assert.match(page, /Version 0\.31\.2/);
  ...
  assert.equal(JSON.parse(packageJson).version, "0.31.2");
